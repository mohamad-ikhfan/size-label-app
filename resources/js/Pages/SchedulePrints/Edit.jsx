...
export default function ScheduletPrintEdit({
    schedulePrint,
    users,
    closeModal = () => {},
}) {
    const { data, setData, put, errors, processing } = useForm({
        ...
        model_name: schedulePrint.model_name,
        qty: schedulePrint.qty,
        status: schedulePrint.status,
        status_updated_by: schedulePrint.status_updated_by,
        status_updated_at: schedulePrint.status_updated_at,
    });

    const submit = (e) => {
        e.preventDefault();

        put(route("schedule-print.update", schedulePrint.id), {
            onSuccess: () => {
                closeModal();
